...
return [
    ...
    */
    ...
    'seo'                 => [
        'author'          => 'blu & orion',
        'description'     => 'PIXEL-Lib - Docs',
        'keywords'        => '',
        'og'              => [
            'title'       => 'PIXEL-Lib - Documentation',
            'type'        => 'article',
            'url'         => '',
            'image'       => '',
            'description' => 'Documentation for the open-source PIXEL-Lib library',
        ]
    ],
  ...
  'forum'                   => [
        ...
        'services'          => [
            'disqus'        => [
                'site_name' => 'docs.bluiscool.dev', // yoursite.disqus.com
            ]
        ]
    ],
