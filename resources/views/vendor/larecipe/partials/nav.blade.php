<div class="fixed pin-t pin-x z-40">
    ...
    <nav class="flex items-center justify-between text-black bg-navbar shadow-xs h-16">
        ...
        <div class="block mx-4 flex items-center">
            ...
            <larecipe-button tag="a" href="https://github.com/bludotbat/pixel-lib" target="__blank" type="black" class="px-4">
                <i class="fab fa-github"></i>
            </larecipe-button>
                <larecipe-button tag="a" href="https://pixel.bluiscool.dev" target="__blank" type="black" class="mx-2 px-4">
